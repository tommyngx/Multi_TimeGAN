...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-dir', type=str, default='checkpoint_physionet_imputed_lastvalue',
                        help='Directory name to save the checkpoints')
    parser.add_argument('--log-dir', type=str, default='logs_physionet_imputed_lastvalue',
    ...
    while epoch<31:
        ...
        with tf.Session(config=config) as sess:
            model = gru_impute_lastValue.grud(sess,
                        args=args,
                        dataset=dt_train,
                        )
